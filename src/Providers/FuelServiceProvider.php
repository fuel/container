...
namespace Fuel\Container\Providers;
...
use Fuel\Container\{Container, ContainerAwareInterface, ContainerInstance};
...
class FuelServiceProvider extends AbstractServiceProvider implements BootableServiceProviderInterface
{
    ...
    public function boot(): void
    {
        $this->getContainer()
            ->inflector(ContainerAwareInterface::class)
                ->invokeMethod('setContainer', [ContainerInstance::class]);
    }
    ...
    public function register(): void
    {
        ...
        // NB: containerInstance is added by the framework bootloader !
    }
}
